<h1>Hello Jan Parareda!!!</h1>
<div class="container col-11 mx-auto">
<p>Espero que et trobis bé i relaxat per fer l'examen.. Les UF's que has de recuperar són la UF2 i la UF3. La UF2 gira al voltant de l'emmagatzematge de dades en variables de sessió i la UF3 al voltant de les bases de dades. Si tires per la via de bases de dades serà
    sufucient per aprovar la UF2 també. En qualsevol cas, si no et vols mullar amb les bases de dades i vols assegurar la UF2, et deixo uns fitxers que t'ajudaran a treballar amb variables de sessió: resetControllerVS.php, Orm_uf2.php i Cotxe.php. Si tens qualsevol dubte, no dubtis en preguntar-me. Molta sort i a per totes! <p>
